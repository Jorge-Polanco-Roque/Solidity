...
contract NFT is ERC721, Ownable {
    ...
    function LevelUp(uint256 _id) public payable {
        require(msg.value >= priceLevelUp, "Insufficient funds");
        require(ownerOf(_id)==msg.sender, "You don't have permissions");
        nfts[_id].level++;
